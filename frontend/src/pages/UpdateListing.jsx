...
const UpdateListing = () => {
  ...
  return (
    <main className='p-4 max-w-4xl mx-auto'>
      <h1 className='text-4xl font-semibold text-center mb-8 mt-2 text-teal-400'>Edit a Listing</h1>
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-8'>
        ...
        <div className="flex flex-wrap gap-4 text-teal-400">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <div className="flex flex-col items-center">
              ...
              {formData.type === 'rent' && <span className='text-xs text-[#9CA3AF]'>(₹/month)</span>}
            </div>
          </div>
          {formData.offer &&
          <div className="flex items-center gap-2">
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <button disabled={loading || uploading} className="text-center border-transparent text-teal-500 text-xl bg-green-700 bg-opacity-40  sm:ml-4 rounded-lg hover:bg-teal-500 hover:text-black hover:scale-105 duration-300 transition-all ease-in-out p-2">{loading?"Updating...":"Update Listing"}</button>
